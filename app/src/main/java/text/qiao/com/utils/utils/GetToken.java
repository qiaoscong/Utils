...
import com.guangyao.friendschat.model.entity.login.Token;
...
public class GetToken {
    ...
    public static String GetRongCloudToken(String username) {
        ...
        String App_Key = "vnroth0kv84io"; //开发者平台分配的 App Key。
        String App_Secret ="bcTvPguQK8A8";
...
//        Logger.i(Signature);
        ...
        LogUtil.e("qiao","结果：---"+res.toString());

        Token userRespone = JSON.parseObject(res.toString(), Token.class);
//        Logger.i(userRespone.getCode()+"");userRespone.getToken()
        return null;
    }
