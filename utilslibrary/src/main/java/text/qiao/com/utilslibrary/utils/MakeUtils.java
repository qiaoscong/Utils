...
public class MakeUtils {
    ...
    private static final String XML_DIMEN_TEMPLETE = "<dimen name=\"_%1$sdp\">%2$sdp</dimen>\r\n";
    ...
    public static void makeAll(int designWidth, DimenTypes type, String buildDir) {
        try {
            ...
            //生成目标目录
            File file = new File(buildDir + File.separator );
            if (!file.exists()) {
//                Log.d("RxJava", "生成目标目录"+file.getAbsolutePath());
                file.mkdirs();
            }
